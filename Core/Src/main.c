...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc) {
    if(hadc->Instance == ADC1) {
    	...
    	if(newStatus != oldStatus) // nếu có sự thay đổi trạng thái
    	{
    	    ...
    	    switch(newStatus)
    	    {
    	        case 0: len = sprintf(msg, "CENTER\r\n"); break;
    	        case 1: len = sprintf(msg, "RIGHT\r\n");  break;
    	        case 2: len = sprintf(msg, "LEFT\r\n");   break;
    	        case 3: len = sprintf(msg, "UP\r\n");     break;
    	        case 4: len = sprintf(msg, "DOWN\r\n");   break;
    	    }
...
/* ===== HAM DEBUG: gui chuoi log qua UART1, dung cho viec chuan doan treo he thong ===== */
void Debug_UartLog(const char* msg, uint32_t len)
{
